...
const eventDefinitions = {
  ...
  CONFIGURATION_UPDATED: { action: "update", verb: "Updated grievance configuration" },
  GRIEVANCE_ASSIGNED: { action: "assign", verb: "Assigned grievance" },
  GRIEVANCE_STATUS_CHANGED: { action: "update", verb: "Changed grievance status" },
  GRIEVANCE_DUE_DATE_CHANGED: { action: "update", verb: "Changed grievance due date" },
  DUE_DATES_BULK_RECALCULATED: { action: "update", verb: "Bulk recalculated grievance due dates" },
  GRIEVANCE_REASSIGNMENT_DECIDED: { action: "update", verb: "Decided grievance reassignment" },
  GRIEVANCE_EXPORTED: { action: "export", verb: "Exported grievances" },
